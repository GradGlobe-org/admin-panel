...
from .views import blog_post_summary_view, blog_post_detail_view, blog_post_create_view, blog_post_update_view, blog_post_delete_view, posts_by_author_view, stream_post_image, upload_image_to_drive, blog_gallery
...
urlpatterns = [
    ...
    path("upload-featured-image/", upload_image_to_drive),
    path("image-gallery/", blog_gallery)
]